      ...
      <div class="row">
        ...
        <div class="col-md-9">
          <div class="box box-primary">
          	<!-- {!! Form::open(array('route' => 'mail.sendMail', 'enctype' => 'multipart/form-data')) !!} -->
            <div class="box-header with-border">
            ...
            <div class="box-body">
              <div class="form-group">
                <input class="form-control" placeholder="To:" name="{{ $receiverAddress }}">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                    ...
                    <textarea id="compose-textarea" name="body" id="body" class="form-control" style="height: 300px">
